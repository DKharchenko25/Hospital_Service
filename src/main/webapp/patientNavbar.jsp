...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand mb-0 h-1" href="patientWelcomePage.jsp">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="patientWelcomePage.jsp"><fmt:message key="navbar.home"/> </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/all_patients_doctors?id=${sessionScope.user.id}"><fmt:message key="patient.my_doctors"/></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/all_patients_cards?id=${sessionScope.user.id}"><fmt:message key="patient.my_card"/></a>
                </li>
                <li class="nav-item">
