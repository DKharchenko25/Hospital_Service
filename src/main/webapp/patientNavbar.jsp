    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/controller?command=all_patients_doctors&id=${sessionScope.user.id}"><fmt:message key="patient.my_doctors"/></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/controller?command=all_patients_cards&id=${sessionScope.user.id}"><fmt:message key="patient.my_card"/></a>
                </li>
                <li class="nav-item">
