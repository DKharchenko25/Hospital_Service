        ...
        <ul class="list-group list-group-flush">
            <c:forEach var="patient" items="${requestScope.patients}">
                <li class="list-group-item">${patient.firstName} ${patient.lastName}
                    ...
                    <a href="${pageContext.request.contextPath}/doctor_cards?patientId=${patient.id}&doctorId=${sessionScope.user.id}"
                    ...
                    <a href="${pageContext.request.contextPath}/add_hospital_card?patientId=${patient.id}&doctorId=${sessionScope.user.id}"
                       class="btn btn-success">
