...
<div class="d-flex">
    <div class="card bg-light mb-3 border-info d-inline-block" style="width: 40rem;">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><b><fmt:message key="login.password"/>:</b> ${requestScope.patient.password}
            </li>
            <li class="list-group-item"><b><fmt:message
    ...
    <div class="card bg-light mb-3 border-info d-inline-block" style="width: 40rem;">
        ...
        <form action="${pageContext.request.contextPath}/update_patient" method="post">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><input class="form-control" type="text" id="lastName" name="newLastName"
                                                   ...
                                                   pattern="[a-zA-ZА-ЩЬЮЯҐЄІЇа-щьюяґєії']+"
                                                   title="<fmt:message key="validation.name.title"/>"/></li>
                <li class="list-group-item"><input id="birthDate" class="form-control" type="date" name="newBirthDate"
                                                   path="birthDate"
                                                   aria-label="<fmt:message key="patients.birth_date"/>"/></li>

                <li class="list-group-item"><input type="email" class="form-control" id="email" name="newEmail"
                                                   path="email"
                                                   placeholder="<fmt:message key="patient.email"/>"
                                                   aria-label="<fmt:message key="patient.email"/>"/>
                </li>

                <li class="list-group-item"><input type="text" class="form-control" id="phoneNumber"
                                                   name="newPhoneNumber"
                                                   path="phoneNumber"
                                                   ...
                                                   title="<fmt:message key="validation.number.title"/>"/></li>
            </ul>
