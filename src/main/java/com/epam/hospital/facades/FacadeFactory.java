...
public class FacadeFactory {
    ...
    static {
        ...
        HOSPITAL_CARD_REPOSITORY = new HospitalCardRepositoryImpl(HOSPITAL_CARD_DAO, PATIENT_REPOSITORY,
                HOSPITAL_STAFF_REPOSITORY);
        ...
        HOSPITAL_CARD_SERVICE = new HospitalCardServiceImpl(HOSPITAL_CARD_REPOSITORY, PATIENT_SERVICE,
                HOSPITAL_STAFF_SERVICE, EMAIL_SERVICE, HOSPITAL_CARD_WRITER);
    }
